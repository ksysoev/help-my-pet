...
var ru_RUIndex = []uint32{ // 36 elements
	// Entry 0 - 1F
	0x00000000, 0x00000020, 0x00000046, 0x000008ad,
	0x000022b5, 0x0000259a, 0x0000267a, 0x0000273c,
	0x000027d5, 0x000028a1, 0x00002934, 0x0000298f,
	0x000029ed, 0x00002a97, 0x00002b2b, 0x00002bb2,
	0x00002bf0, 0x00002c1f, 0x00002c57, 0x00002c64,
	0x00002c6f, 0x00002ca7, 0x00002d4b, 0x00002d7d,
	0x00002d8c, 0x00002d9b, 0x00002e43, 0x00002e91,
	0x00002e96, 0x00002e9d, 0x00002efe, 0x00002f0b,
	// Entry 20 - 3F
	0x00002f1a, 0x00002f29, 0x00002f80, 0x0000300b,
} // Size: 168 bytes

const ru_RUData string = "" + // Size: 12299 bytes
	...
	"оящих симптомов или поведения\x0a- Советами по диете и питанию, включая" +
	" фотографии еды или угощений, которые вы рассматриваете\x0a- Советами и " +
	"техникой дрессировки - вы можете отправлять фотографии конкретных ситуа" +
	"ций, в которых вам нужна помощь\x0a- Общими рекомендациями по уходу за " +
	"питомцем, с анализом фотографий окружения или принадлежностей вашего пи" +
	"томца\x0a\x0aПросто задайте мне вопрос или отправьте фотографии вместе " +
	"с вашими опасениями о вашем питомце, и я предоставлю полезные, информат" +
	"ивные ответы на основе надежных ветеринарных знаний. При необходимости " +
	"вы можете отправить несколько фотографий, чтобы лучше показать ситуацию" +
	".\x0a\x0aПомните, что хотя я могу предложить рекомендации и анализироват" +
	"ь фотографии, в случае серьезных медицинских состояний всегда проконсул" +
	"ьтируйтесь с ветеринаром.\x0a\x0aЧтобы начать, просто задайте мне любой" +
	" вопрос о вашем питомце - с фотографиями или без них!\x02<b>Условия и по" +
	"ложения</b>\x0a<i>Последнее обновление: 30.01.2025</i>\x0a\x0aСпасибо з" +
	"а использование нашего чат-бота для ветеринарных консультаций («Сервис»" +
	"). Получая доступ или используя этот Сервис, вы соглашаетесь соблюдать с" +
	"ледующие условия и положения («Условия»). Если вы не согласны с этими У" +
	"словиями, пожалуйста, немедленно прекратите использование.\x0a\x0a<b>1." +
	" Характер Сервиса</b>\x0a1.1 Сервис предоставляет общую информацию, реко" +
	"мендации и предложения по уходу за питомцами, включая (но не ограничива" +
	"ясь) диету, поведение и дрессировку.\x0a1.2 Сервис не является заменой " +
	...
	"вяжитесь с нами по адресу <i>k.sysoev@me.com</i>.\x02<b>Команды Help My" +
	" Pet Bot</b>:\x0a/start - Начать разговор с ботом\x0a/terms - Просмотрет" +
	"ь Условия и положения сервиса\x0a/editprofile - Обновить информацию про" +
	"филя вашего питомца, такую как имя, возраст, порода и т. д. Эта информа" +
	"ция помогает боту предоставлять более точные советы.\x0a/cancel - Отмен" +
	"ить текущий опрос, если он в процессе (например, когда вы хотите начать" +
	" сначала или изменить свой вопрос)\x0a/help - Просмотреть это сообщение " +
	"справки\x02Извините, я не могу обрабатывать видео, аудио или документы." +
	" Пожалуйста, отправьте свой вопрос только в текстовом формате.\x02Извини" +
	"те, но ваше сообщение слишком длинное для обработки. Попробуйте сделать" +
	" его более кратким и сжатым.\x02Вы достигли максимального количества зап" +
	"росов в час. Пожалуйста, попробуйте позже.\x02Мы достигли нашего ежедне" +
	"вного лимита запросов. Пожалуйста, вернитесь завтра, когда наш бюджет б" +
	"удет обновлен.\x02Пожалуйста, предоставьте свой вопрос в текстовом форм" +
	"ате вместе с фотографиями\x02Пожалуйста, предоставьте хотя бы одну фото" +
	"графию\x02Пожалуйста, предоставьте не более %[1]d фотографии(й)\x02Изви" +
	...
	"формате ГГГГ-ММ-ДД (например, 2023-12-31)\x02Профиль питомца успешно со" +
	"хранен\x02Как зовут вашего питомца?\x02Какое у вас домашнее животное?" +
	"\x02собака\x02кошка\x02Какая порода у вашего питомца?\x02Когда родился в" +
	"аш питомец? Пожалуйста, введите дату в формате ГГГГ-ММ-ДД (например, 20" +
	"10-12-31).\x02Какой пол у вашего питомца?\x02мужской\x02женский\x02Какой" +
	" вес у вашего питомца? Укажите вес, за которым следует единица измерения" +
	", например, 5 кг\x02Ваш питомец стерилизован или кастрирован?\x02да\x02н" +
	"ет\x02Как вы бы описали уровень активности вашего питомца?\x02низкий" +
	"\x02средний\x02высокий\x02У вашего питомца есть хронические заболевания?" +
	"\x02Какие у вашего питомца предпочтения в питании или диетические ограни" +
	"чения?"
...
const uk_UAData string = "" + // Size: 11895 bytes
	...
	// Total table size 124319 bytes (121KiB); checksum: 2849E0AA
