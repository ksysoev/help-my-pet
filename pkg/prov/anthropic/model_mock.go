...
func (_m *MockModel) Call(ctx context.Context, prompt string) (string, error) {
...
//   - ctx context.Context
//   - prompt string
func (_e *MockModel_Expecter) Call(ctx interface{}, prompt interface{}) *MockModel_Call_Call {
	return &MockModel_Call_Call{Call: _e.mock.On("Call", ctx, prompt)}
}

func (_c *MockModel_Call_Call) Run(run func(ctx context.Context, prompt string)) *MockModel_Call_Call {
...
func (_c *MockModel_Call_Call) RunAndReturn(run func(context.Context, string) (string, error)) *MockModel_Call_Call {
	_c.Call.Return(run)
	return _c
}
